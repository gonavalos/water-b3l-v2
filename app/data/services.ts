...
export const servicesData: ServiceItem[] = [
  {
    ...
    short:
      "Construimos modelos hidráulicos trazables para ríos, canales y planicies, con simulación transitoria, acople 1D–2D y análisis de sensibilidad para comparar alternativas de obra y operación.",
    bullets: [
      ...
      "Entregables reproducibles: scripts, mapas y versionado",
    ],
    href: "/servicios/modelacion-1d-2d",
    icon: "waves",
    kpis: [
      { label: "NSE", value: "≥0.90" },
      { label: "R²", value: "≥0.90" },
    ],
  },
  {
    ...
    short:
      "Diseñamos y verificamos redes pluviales y soluciones basadas en la naturaleza: malla dual calle–colector, almacenamiento y control operacional para reducir anegamientos y sobreelevaciones.",
    bullets: [
      ...
      "SuDS: bioretención, zanjas drenantes, pavimentos permeables",
    ...
    icon: "droplets",
    kpis: [{ label: "Anegamientos", value: "−15%" }],
  },
  {
    id: "sig-lidar",
    title: "SIG / LiDAR",
